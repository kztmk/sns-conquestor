              ...
              <Grid item xs={8}>
                ...
                >
                  ...
                  >
                    ...
                    Marketplace and used by over 2.5K+ Customers wordwide.
                  </Typography>
                </motion.div>
              </Grid>
            </Grid>
          ...
          <Grid item>
            ...
            >
              <Tooltip title="Click to Preview CodeIgniter">
                <Link
                  component={Link}
                  href="https://ableproadmin.com/codeigniter/default/public/"
                  target="_blank"
                >
          ...
          <Grid item>
            ...
            >
              <Tooltip title="Figma Design System">
                <Link component={Link} href="https://links.codedthemes.com/mQZrX" target="_blank">
